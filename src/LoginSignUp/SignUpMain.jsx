...
const SignUpMain = () => {
  ...
  const onChangeRePW2 = (e) => {
    setRePassword2(e.target.value);
  };
      ...
      <form className="SignUpMainSection" onSubmit={onSubmitUserData}>
        ...
        <div className="SignUpValueBlock">
          ...
          <div className="SignUpInputBlock">
            ...
            >
              <option value="none">국가번호를 선택하세요</option>
              ...
              <option value="509">아이디 +509</option>
              ...
              <option value="947">카타르 +947</option>
              ...
              <option value="595">프랑스령마르티니크 +595</option>
        ...
        <button className="SignUpMainButton" type="submit">
          가입하기
        </button>
      </form>
    </div>
